...
export const mockFloor: FloorPlan = {
  ...
  backgroundImageUrl: "/downstairs.png"
};
...
export const mockOutlets: Outlet[] = [
  ...
  { id: "o5", name: "Exterior Front", kind: "OUTLET", x: 820, y: 140, circuitId: "c2", controlledBySwitchId: "o10" },
  { id: "o6", name: "Exterior Rear", kind: "OUTLET", x: 820, y: 260, circuitId: "c2", controlledBySwitchId: "o10" },
  { id: "o7", name: "Bath GFCI", kind: "OUTLET", x: 480, y: 400, circuitId: "c3", isGfci: true },
  { id: "o8", name: "Bath Light", kind: "LIGHT", x: 520, y: 320, circuitId: "c3", controlledBySwitchId: "o11" },
  { id: "o9", name: "Bath Fan", kind: "APPLIANCE", x: 560, y: 360, circuitId: "c3", controlledBySwitchId: "o11" },
  { id: "o10", name: "Exterior Switch", kind: "SWITCH", x: 760, y: 300, circuitId: "c2", controlsOutletIds: ["o5", "o6"] },
  { id: "o11", name: "Bath Switch", kind: "SWITCH", x: 460, y: 340, circuitId: "c3", controlsOutletIds: ["o8", "o9"] }
];
